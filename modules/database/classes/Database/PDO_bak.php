...
class Database_PDO2 extends Database2 {
	...
	protected function _connect() {
		...
		$attrs = array(PDO_bak::ATTR_ERRMODE => PDO_bak::ERRMODE_EXCEPTION);
		if (!empty($persistent)) $attrs[PDO_bak::ATTR_PERSISTENT] = TRUE;

		try {
			$this->_conn = new PDO_bak($dsn, $username, $password, $attrs);
